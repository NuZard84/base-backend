...
// cors, transports and ping settings are applied at the server level via
// SocketIoAdapter in main.ts. Putting them here (namespace level) causes
// Socket.IO to reject the namespace with "Invalid namespace".
@WebSocketGateway()
